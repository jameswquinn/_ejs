...
gulp.task('templates', function() {
  gulp.src('dist/*.html')
    .pipe(htmlmin({collapseWhitespace: true, collapseInlineTagWhitespace: true, removeTagWhitespace: true, removeComments: true}))
...
gulp.task('png', function () {
    return gulp.src('public/logo/Donald Trump.svg')
        .pipe(convert({width: 500, height: 500}))
...
gulp.task('uncss', function () {
    return gulp.src('dist/css/milligram.css')
